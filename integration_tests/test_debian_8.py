...
@pytest.mark.debian8
def test_agent_system_on_debian_8(phial, capsys, regex):
...
@pytest.mark.debian8
def test_agent_pc3x_on_debian_8(phial, capsys, regex):
    with capsys.disabled():
        acceptance = PuppeterAcceptance(phial)
...
@pytest.mark.debian8
def test_agent_pc4x_on_debian_8(phial, capsys, regex):
    with capsys.disabled():
        acceptance = PuppeterAcceptance(phial)
...
@pytest.mark.debian8
def test_agent_pc5x_on_debian_8(phial, capsys, regex):
    with capsys.disabled():
        acceptance = PuppeterAcceptance(phial)
