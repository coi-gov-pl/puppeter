...
def sut():
    """System Under Test"""
    return join('redhat', 'centos-6')


@pytest.mark.centos6
def test_simple_pc3x_on_centos_6(phial, capsys, regex):
...
@pytest.mark.centos6
def test_simple_pc4x_on_centos_6(phial, capsys, regex):
    with capsys.disabled():
        acceptance = PuppeterAcceptance(phial)
...
@pytest.mark.centos6
def test_simple_pc5x_on_centos_6(phial, capsys, regex):
    with capsys.disabled():
        acceptance = PuppeterAcceptance(phial)
