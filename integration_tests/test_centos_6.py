...
@pytest.mark.centos6
def test_agent_pc3x_on_centos_6(phial, capsys, regex):
...
@pytest.mark.centos6
def test_agent_pc4x_on_centos_6(phial, capsys, regex):
    with capsys.disabled():
        acceptance = PuppeterAcceptance(phial)
...
@pytest.mark.centos6
def test_agent_pc5x_on_centos_6(phial, capsys, regex):
    with capsys.disabled():
        acceptance = PuppeterAcceptance(phial)
